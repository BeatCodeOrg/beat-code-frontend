...
function WaitingPage() {
    ...
    return (
            ...
            <div className="overlap-wrapper">
              <div className="overlap">
                <div className="overlap-group">
                  <img className="group" alt="Group" src="src/assets/waiting-page/computer.png" />
                  
                  <div className = "box">

                  <div className="rectangle"src="src/assets/waiting-page/rectangle.png" />
                  </div> 

                  <FilterChoice filterName="Algorithms"/>
                  ...
                  <div className="question-type">
                    ...
                    <div className="choice">
                      <div className="div-wrapper">
                        <div FilterChoice = ""> Algorithms</div>
                  ...
                  <div className="difficulty">
                    ...
                    <div className="overlap-10">
                      <img className="line" alt="Line" src="src/assets/waiting-page/line.png" />
                  ...
                  <img className="polygon" alt="Polygon" src="src/assets/waiting-page/polygon1.png" />
                  <img className="img" alt="Polygon" src="src/assets/waiting-page/polygon2.png" />
            ...
            <img className="surface-laptop" alt="Surface laptop" src="src/assets/waiting-page/surfacelaptop.png" />
            <img className="vector" alt="Vector" src="src/assets/waiting-page/vector1.png" />
